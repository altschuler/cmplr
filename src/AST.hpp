...
public:
	ImportAST(string fileName, int pcp)
			: FileName(fileName), ParentCursorPosition(pcp) {
	}
};
...
public:
	...
	vector<ConditionalElement*> GetConds() {
		return this->Conds;
	}
	BlockAST *GetElse() {
		return this->Else;
...
class FunctionAST {
	...
	BlockAST *Body;
	public:
	FunctionAST(PrototypeAST *prototype, BlockAST *body)
